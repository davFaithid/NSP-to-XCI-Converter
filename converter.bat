...
call :getname
echo ---------------------------
echo Extracting secure partition
echo ---------------------------
...
echo *******************************************************
echo Press "1" to repack list as xci
echo Press "2" to repack list as both xci and nsp
echo Please understand that when converting as both, it may error.
set /p bs="Enter your choice: "
set bs=%bs:"=%
set vrepack=none
if /i "%bs%"=="1" set "vrepack=xci"
if /i "%bs%"=="2" set "vrepack=both"
...
echo ...........................
echo Press "1" to repack as xci
echo Press "2" to repack as both xci and nsp
echo ...........................
echo.
set /p bs="Enter your choice: "
set bs=%bs:"=%
if /i "%bs%"=="1" set "repack=XCI"
if /i "%bs%"=="2" set "repack=BOTH"
...
:squirrell
echo                    ,;:;;,    _____             _                __
echo                   ;;;;;     / ___/____ ___  __(_)____________  / /
echo           .=',    ;:;;:,    \__ \/ __ `/ / / / / ___/ ___/ _ \/ / 
echo          /_', "=. ';:;:;   ___/ / /_/ / /_/ / / /  / /  /  __/ /  
echo          @=:__,  \,;:;:'  /____/\__, /\__,_/_/_/  /_/   \___/_/ 
echo            _(\.=  ;:;;'           /_/                             
echo           `"_(  _/="`
echo            `"'		
echo.
echo JULESONTHEROAD's squirrel is hard at work!
echo.
exit /B
