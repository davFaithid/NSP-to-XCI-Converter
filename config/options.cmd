...
set "w_folder=_temp"
::output folder
set "fold_output=_output"
::--------------------------------------------------------------
::OPTION 2: PROGRAM ROUTES
::--------------------------------------------------------------
set "nut=tools\nut_RTR.py"
set "xci_lib=tools\XCI.bat"
set "nsp_lib=tools\NSP.bat"
set "zip=tools\7za.exe"
set "hactool=tools\hactool.exe
set "hacbuild=tools\hacbuild.exe"
::--------------------------------------------------------------
...
set "game_info=config\game_info_preset.ini"
::Route for keys.txt 
set "dec_keys=tools\keys.txt"
::--------------------------------------------------------------
